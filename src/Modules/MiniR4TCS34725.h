...
public:
    Adafruit_TCS34725(
        uint8_t = TCS34725_INTEGRATIONTIME_2_4MS, tcs34725Gain_t = TCS34725_GAIN_1X,
        uint8_t addr = TCS34725_ADDRESS, TwoWire* theWire = &Wire, uint8_t mux = -1);
...
private:
    MiniR4_I2CDevice* i2c_dev = NULL;   ///< Pointer to I2C bus interface
