...
Adafruit_TCS34725::Adafruit_TCS34725(
    uint8_t it, tcs34725Gain_t gain, uint8_t addr, TwoWire* theWire, uint8_t mux_ch)
{
    _tcs34725Initialised     = false;
    _tcs34725IntegrationTime = it;
    _tcs34725Gain            = gain;
    if (i2c_dev) delete i2c_dev;
    i2c_dev = new MiniR4_I2CDevice(addr, theWire, mux_ch);
}
 ...
 *  @return Color temperature in degrees Kelvin
 */
uint16_t Adafruit_TCS34725::calculateColorTemperature_dn40(
